...
private:
	...
	std::vector<Ptr<WarningsPacket> > 	m_packetSentLog;	// PacketId is key, remaining time is value,it is used to log those sented but not relayed packets; it is supposed to fail if remaining time is larger than valid time
